...
import { GraduationCap, ArrowLeft, BookOpen, Users, Trophy, CheckCircle } from "lucide-react"

const studentBenefits = [
  "Access to 200+ premium courses",
  "Interactive video lessons with subtitles",
      ...
      <main className="pt-32 px-6 pb-16">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <span className="mb-6 inline-flex items-center gap-2 rounded-full border border-border bg-card px-4 py-2 text-[10px] font-semibold uppercase tracking-wider text-muted-foreground">
                <BookOpen className="w-4 h-4" />
                Student Portal
              </span>

              <h1 className="mb-6 text-balance text-4xl font-semibold leading-tight tracking-tight text-foreground md:text-5xl">
                Start your <span className="text-primary">learning</span> journey today.
              </h1>

              <p className="mb-10 max-w-md text-lg leading-relaxed text-muted-foreground">
                Join thousands of students mastering English, Persian, and technology skills with our world-class instructors.
              </p>
            ...
            >
              ...
              <div className="relative rounded-xl border border-border bg-card p-10 text-center shadow-sm md:p-12">
                ...
                <h2 className="mb-3 text-xl font-semibold text-foreground">Create your account</h2>
                <p className="mb-10 text-sm leading-relaxed text-muted-foreground">
                  Click the button below to fill out the registration form and join the Growave community.
                </p>

                {/* دوگمەی لینکەکە بۆ قوتابیان */}
                <Link 
                  href="https://2kdasdrgw7.zite.so" 
                  target="_blank"
